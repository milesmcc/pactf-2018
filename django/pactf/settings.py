...
class _Django(Configuration):
    ...
    DEFAULT_FROM_EMAIL = values.Value('noreply@pactf.com', environ_prefix=email_prefix)
    SERVER_EMAIL = values.Value('noreply@pactf.com', environ_prefix=None)
